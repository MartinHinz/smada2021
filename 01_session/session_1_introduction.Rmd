...
schedule <- c(
  "24.02.2021", "Session: Introduction](01_session/session_1_introduction.html)", "01",
"03.03.2021", "Session: Introduction into R", "02",
"10.03.2021", "Session: Explorative Statistics/Graph. Display", "03",
"17.03.2021", "Session: Descriptive Statistics", "04",
"24.03.2021", "Session: Nonparametric Tests", "05",
"31.03.2021", "Session: Chi-square test", "06",
"14.04.2021", "Session: Probability Theory and Distributions", "07",
"21.04.2021", "Session: Distributions", "08",
"28.04.2021", "Session: Parametric Tests", "09",
"05.05.2021", "Session: Regression & Correlation", "10",
"12.05.2021", "Session: Cluster Analysis", "11",
"26.05.2021", "Session: Correspondence Analysis", "12",
"02.06.2021",  "Test", "-"
)
...
olom <- as.data.frame(matrix(olom,ncol=5, byrow = T))
colnames(olom) <- c("scale", "count", "sort", "difference", "quotient")
knitr::kable(olom)  %>%
  kable_styling(bootstrap_options = c("striped", "hover"),
                latex_options = "striped",
                full_width = T)
