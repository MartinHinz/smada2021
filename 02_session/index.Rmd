...
participants<-c("Hannah", "Leon", "Lukas", "Leonie", "Luka", "Lea", "Lena", "Mia", "Tim", "Fynn", "Anna", "Emily", "Felix")
height<-c(154, 167, 187, 165, 190, 176, 167, 156, 154, 165, 167, 171, 154)
...
```{r echo=F}
kursmatrix <- cbind(height,c(sample(18:25,13, replace = T),NA))
colnames(kursmatrix) <- NULL
rownames(kursmatrix) <- NULL
save(kursmatrix, file = "kursmatrix.RData")
```
## matrices [1]
